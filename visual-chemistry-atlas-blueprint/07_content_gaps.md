...
| P0 | Later-batch schema failure | Audit baseline: 220 topic Markdown files lacked required front matter and 80 required topic files were absent. After repair batch R02: 198 lack front matter and 72 required files are absent | Continue restoring the four missing core records and migrating all Markdown records for the remaining 18 affected topics |
...
R01 and R02 deliberately do not promote page readiness in the frozen audit tables. Creating a record or verifying a source packet is not equivalent to approving final scientific copy or art.
...
| --- | --- | --- |
| `common-misconceptions.md` | Present in 22 topics after R02; many earlier files still contain a blank template and the repaired quantum record has no promotable misconception evidence | The mandatory misconception block cannot be populated reliably |
| `equations.md` | Present in 22 topics after R02 and contains 21 explicit records total | Quantitative spreads are missing or under-specified |
| `terminology.md` | Present in 22 topics after R02; 18 later-batch topics still use informal queues | Glossary cannot be treated as controlled vocabulary |
| `research-queue.md` | Present in 22 topics after R02; 18 later-batch topics still embed future work inside content files | Work status and publishable evidence are mixed |
